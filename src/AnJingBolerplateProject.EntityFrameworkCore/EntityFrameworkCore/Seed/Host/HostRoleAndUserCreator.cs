...
namespace AnJingBolerplateProject.EntityFrameworkCore.Seed.Host
{
    public class HostRoleAndUserCreator
    {
        private readonly AnJingBolerplateProjectDbContext _context;

        public HostRoleAndUserCreator(AnJingBolerplateProjectDbContext context)
        {
            _context = context;
        }
        ...
        private void CreateHostRoleAndUsers()
        {
            ...
            var permissions = PermissionFinder
                .GetAllPermissions(new AnJingBolerplateProjectAuthorizationProvider())
